...
connect4.activeConsole = function () {
    "use strict";
    var x, // x coordinate
        y; // y coordinate
    //isPlayer1 = true; //flag to indicate if it's player1 turn "true" (or player2 turn "false"), we use the graphic mode variable

    //initialition of the board, its not neccesary because we initialize in graphic mode
    //connect4.board.initBoard();
    //we disable the graphic mode
    connect4.play.disableGraphicMode();
